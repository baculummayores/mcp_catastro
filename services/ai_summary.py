...
from models.catastro_models import ResumenIA, CatastroResponse
...
class AIService:
    ...
    async def generar_resumen(self, referencia: str, usar_openai: bool = False, idioma: str = "es") -> str:
        """
        ...
        try:
            ...
            logger.error(f"Error generando resumen para {referencia}: {str(e)}")
        ...
        try:
            ...
            response = await self._openai_client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": self._get_system_prompt(idioma)
                    },
                    {
                        "role": "user", 
                        "content": prompt
            ...
            logger.info(f"Resumen generado con OpenAI para {datos.referencia_catastral}")
        ...
        try:
            ...
            plantillas = {
                "es": {
                    ...
                    "superficie": "**Superficie construida:** {superficie} m²\n" if datos.datos_basicos and datos.datos_basicos.superficie_construida else "",
                    "antiguedad": "**Año construcción:** {antiguedad}\n" if datos.datos_basicos and datos.datos_basicos.antiguedad else "",
                    "direccion": "**Dirección:** {direccion}\n" if datos.direccion and datos.direccion.via else "",
                ...
                "en": {
                    ...
                    "uso": "**Use:** {uso}\n" if datos.datos_basicos and datos.datos_basicos.uso else "",
                    "superficie": "**Built area:** {superficie} m²\n" if datos.datos_basicos and datos.datos_basicos.superficie_construida else "",
                    "antiguedad": "**Construction year:** {antiguedad}\n" if datos.datos_basicos and datos.datos_basicos.antiguedad else "",
                ...
                "ca": {
                    ...
                    "uso": "**Ús:** {uso}\n" if datos.datos_basicos and datos.datos_basicos.uso else "",
                    "superficie": "**Superfície construïda:** {superficie} m²\n" if datos.datos_basicos and datos.datos_basicos.superficie_construida else "",
                    "antiguedad": "**Any construcció:** {antiguedad}\n" if datos.datos_basicos and datos.datos_basicos.antiguedad else "",
            ...
            if datos.datos_basicos:
                ...
                if datos.datos_basicos.superficie_construida:
                    resumen += plantilla["superficie"].format(superficie=datos.datos_basicos.superficie_construida)
                if datos.datos_basicos.antiguedad:
                    resumen += plantilla["antiguedad"].format(antiguedad=datos.datos_basicos.antiguedad)
            ...
            logger.info(f"Resumen simulado generado para {datos.referencia_catastral}")
            return resumen
            
        except Exception as e:
            logger.error(f"Error generando resumen simulado: {str(e)}")
            return f"Error generando resumen: {str(e)}"
    ...
    def _generar_analisis_automatico(self, datos: CatastroResponse, idioma: str) -> str:
        ...
        try:
            ...
            logger.warning(f"Error generando análisis automático: {str(e)}")
        
        return analisis
    
    def _construir_prompt(self, datos: CatastroResponse, idioma: str) -> str:
        """Construye el prompt para OpenAI"""
        prompt = f"Analiza los siguientes datos catastrales y genera un resumen profesional:\n\n"
