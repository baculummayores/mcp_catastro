...
class ReferenciaCatastral(BaseModel):
    ...
    referencia: str = Field(
        ..., description="Referencia catastral de 20 caracteres", min_length=20, max_length=20
    )
    ...
    def analizar_referencia_detallado(referencia: str) -> dict:
        ...
        if longitud == 0:
            analisis.update({"tipo": "vacia", "estado": "error", "mensaje": "Referencia vacía"})
        elif longitud == 14:
            analisis.update(
                {
            ...
            analisis.update(
                {
                    ...
                    "explicacion": "Las referencias catastrales españolas tienen exactamente 20 caracteres. Verifica que no haya caracteres extra.",
                }
            )
        elif longitud == 20:
